      ...
      <div className="container mx-auto h-full flex items-center justify-center px-4 relative z-20">
        <div className="text-center">
          <h1 className="text-4xl md:text-5xl lg:text-6xl text-textColor-100 font-bold">
            Verreisen mit Fortjetzt
          </h1>
          <p className="mt-4 text-lg md:text-xl text-textColor-100">
            Entdecke die fesselndsten Reiseziele und erlebe unvergessliche Momente
          </p>
          <Link
            to="/reisearten"
            className="mt-8 bg-ctaColor-100 text-bgColor-100 px-8 py-3 rounded-md text-lg font-semibold inline-block"
          >
            Jetzt entdecken
          </Link>
        </div>
